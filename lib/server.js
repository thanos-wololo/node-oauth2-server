...
OAuth2Server.prototype.authenticate = function(request, response, options, callback, expReqCtx) {
  ...
  return new AuthenticateHandler(options)
    .handle(request, response, expReqCtx)
    .nodeify(callback);
};
...
OAuth2Server.prototype.authorize = function(request, response, options, callback, expReqCtx) {
  options = Object.assign({
...
OAuth2Server.prototype.token = function(request, response, options, callback, expReqCtx) {
  options = Object.assign({
