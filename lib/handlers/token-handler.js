...
TokenHandler.prototype.handle = function(request, response, expReqCtx) {
  ...
  return Promise.bind(this)
    .then(function() {
      return this.getClient(request, response, expReqCtx);
    })
    .then(function(client) {
      return this.handleGrantType(request, client, expReqCtx);
    })
    .tap(function(data) {
...
TokenHandler.prototype.getClient = function(request, response, expReqCtx) {
  ...
  return promisify(this.model.getClient, 3).call(this.model, credentials.clientId, credentials.clientSecret, expReqCtx)
    .then(function(client) {
      if (!client) {
...
TokenHandler.prototype.handleGrantType = function(request, client, expReqCtx) {
  const grantType = request.body.grant_type;
  ...
  return new Type(options)
    .handle(request, client, expReqCtx);
};
